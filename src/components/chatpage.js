        ...
        <div className='flex flex-col items-center w-[100vw] h-[100svh] bg-[#000000]'>
          ...
          <div className="bg-[#000000] w-[95%]">
            ...
            <div className='h-[10svh]  bg-[#000000] flex justify-center items-center'>
              <form onsubmit={handleChat} className='w-[95%] bg-[#000000] h-full flex items-center'>
                <input
                ...
                />
                <button type='submit' className='p-2 pl-3 pr-3 rounded-[5px] h-[75%] border-[#dfdfdf] rounded-l-[0px] border-r-[1px] border-t-[1px] border-b-[1px] text-[#a8a8a8] font-mochiy-pop' onClick={handleChat}><IoIosSend /></button>
              </form>
            </div>
          </div>
        </div>
